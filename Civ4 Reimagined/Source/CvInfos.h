...
public:
	...
	virtual bool readPass4(CvXMLLoadUtility* pXML) { pXML; FAssertMsg(false, "Override this"); return false; }
...
public:
	...
	int getCoastBonusCommerce() const; // Civ4 Reimagined, Exposed to Python
...
protected:
	...
	int m_iCoastBonusCommerce; // Civ4 Reimagined
...
public:
	...
	int getPrereqCivic() const;						// Exposed to Python  // Civ4 Reimagined
	...
	bool isBlitz() const; // Civ4 Reimagined
...
protected:
	...
	int m_iFeatureProductionModifier; // Civ4 Reimagined
	int m_iFirstStrikes;
	...
	int m_iPrereqCivic;	//Civ4 Reimagined
	...
	bool m_bNoUpkeep; // Civ4 Reimagined
	bool m_bPillage;
	bool m_bSpy;
	bool m_bSabotage;
	bool m_bDestroy;
...
public:
	...
	int getExtraHappiness() const; // Civ4 Reimagined
	int getExtraHealth() const;						// Exposed to Python
	int getPollutionModifier() const; //Leoreth
	int getPopulationUnhappinessModifier() const; // Civ4 Reimagined
	...
	int getGoldPerHappinessBonus() const; // Civ4 Reimagined
	...
	int getWonderProductionBonus() const; //Civ4 Reimagined
	int getExpInBorderModifier() const;				// Exposed to Python
	int getDomesticTradeModifier() const; //Civ4 Reimagined
	int getColonyTradeModifier() const; //Civ4 Reimagined
	int getCapitalTradeModifier() const; //Civ4 Reimagined
	...
	int getBonusRatioModifier() const; //Civ4 Reimagined
	...
	bool isNoCapitalUnhappiness() const; // Civ4 Reimagined
	...
	bool isNoGreatPeople() const; //Civ4 Reimagined
	bool isNoCultureFlip() const; //Civ4 Reimagined
	bool isNoCapital() const; //Civ4 Reimagined
	...
	int* getCapitalExtraYieldFromCityPercentArray() const; // Civ4 Reimagined
	...
	int getExtraSpecialists(int i) const; // Civ4 Reimagined

	int getSpecialistYieldChanges(int i, int j) const;	//Civ4 Reimagined			// Exposed to Python
	int getSpecialistCommerceChanges(int i, int j) const;	//Civ4 Reimagined
	int getImprovementYieldChanges(int i, int j) const;				// Exposed to Python
	int getRadiusImprovementCommerceChanges(int i, int j) const; // Civ4 Reimagined
	int getBuildingYieldChanges(int i, int j) const;	//Civ4 Reimagined			// Exposed to Python
...
protected:
	...
	int m_iExtraHappiness; // Civ4 Reimagined
	int m_bNoCapitalUnhappiness; // Civ4 Reimagined
	int m_iExtraHealth;
	...
	int m_iWonderProductionBonus; //Civ4 Reimagined
	...
	int m_iBonusRatioModifier; //Civ4 Reimagined
	...
	bool m_bUnlimitedAnimalXP; // Civ4 Reimagined
	bool m_bStateReligion;
	bool m_bNoNonStateReligionSpread;
	bool m_bNoGreatPeople; //Civ4 Reimagined
	bool m_bNoCultureFlip; //Civ4 Reimagined
	...
	int* m_piCapitalCommerceModifierPerHappinessSurplus; // Civ4 Reimagined
	int* m_piExtraCommerceHappiness; // Civ4 Reimagined
	int* m_piStateReligionBuildingCommerce; // Civ4 Reimagined
	...
	int** m_ppiSpecialistYieldChanges; // Civ4 Reimagined
	int** m_ppiSpecialistCommerceChanges; // Civ4 Reimagined
	int** m_ppiImprovementYieldChanges;
	int** m_ppiRadiusImprovementCommerceChanges; // Civ4 Reimagined
	int** m_ppiBuildingYieldChanges; // Civ4 Reimagined
...
public:
	...
	int getPrereqAndBonus() const;				// Exposed to Python
	int getBonusFatCross() const; // Civ4 Reimagined
	...
	//int getDefenseWarWearinessModifier() const; // Civ4 Reimagined
	...
	int getTargetAirStrike() const;					// Exposed to Python
	...
	bool isPrereqPowerOr() const; // Civ4 Reimagined
	bool isPrereqPowerAnd() const; // Civ4 Reimagined
	...
	bool isUnlimitedBarbXP() const;	// Civ4 Reimagined
	bool isBarbarianGreatGeneral() const; // Civ4 Reimagined
	bool isCanFarmHills() const; // Civ4 Reimagined
	bool isNoNonStateReligionSpread() const; // Civ4 Reimagined
	int getLootingModifier() const; // Civ4 Reimagined
	...
	int getBonusUnitProductionModifier(int i) const;	// Civ4 Reimagined
	int getBonusBuildingProductionModifier(int i) const;	// Civ4 Reimagined
	int getBonusProductionModifier(int i) const;				// Exposed to Python
...
/************************************************************************************************/
	...
	bool isAnyBonusCommerceModifier() const; // Civ4 Reimagined
/************************************************************************************************/
...
/************************************************************************************************/
	...
	// < Building Civic Prereqs Start >
	bool isPrereqCivic(int i) const;
	// < Building Civic Prereqs End   >
	
	// Civ4 Reimagined
	bool hasPrereqCivics() const;
	...
	// < Building Civic Prereqs Start >
	bool readPass3();
	bool readPass4(CvXMLLoadUtility* pXML);
	// < Building Civic Prereqs End   >
...
protected:
	...
	//int m_iDefenseWarWearinessModifier; // Civ4 Reimagined
	...
	int m_iTargetAirStrike;
	int m_iLootingModifier; // Civ4 Reimagined
	int m_iStateReligionFreeExperience; // Civ4 Reimagined
	int m_iNavalLevelPrereq; // Civ4 Reimagined
	...
	bool m_bPrereqPowerOr; // Civ4 Reimagined
	bool m_bPrereqPowerAnd; // Civ4 Reimagined
	...
	bool m_bUnlimitedBarbXP; // Civ4 Reimagined
	bool m_bBarbarianGreatGeneral; // Civ4 Reimagined
	...
	int* m_piBonusUnitProductionModifiers; // Civ4 Reimagined
	int* m_piBonusBuildingProductionModifiers; // Civ4 Reimagined
	int* m_piBonusProductionModifier;
...
/************************************************************************************************/
	...
	bool m_bAnyBonusCommerceModifier; // Civ4 Reimagined
/************************************************************************************************/
/* UNOFFICIAL_PATCH                        END                                                  */
/************************************************************************************************/
...
public:
	...
	bool isUpgrade() const; //Civ4 Reimagined
	int getProduction() const; //Civ4 Reimagined
	int getFood() const; //Civ4 Reimagined
	int getCulture() const; //Civ4 Reimagined
	int getGreatPersonPoints() const; //Civ4 Reimagined
	int getGreatGeneralPoints() const; //Civ4 Reimagined
	bool isSpecialPromotion() const; //Civ4 Reimagined
...
protected:
	...
	bool m_bUpgrade; //Civ4 Reimagined
	int m_iProduction; //Civ4 Reimagined
	int m_iFood; //Civ4 Reimagined
	int m_iCulture; //Civ4 Reimagined
	int m_iGreatPersonPoints; //Civ4 Reimagined
	int m_iGreatGeneralPoints; //Civ4 Reimagined
	bool m_bSpecialPromotion; //Civ4 Reimagined
...
public:
	...
	bool isCoastal() const; // Civ4 Reimagined
	bool isSlaves() const; // Civ4 Reimagined
	int getMissionType() const;					// Exposed to Python
	int getNumBonuses() const; // Civ4 Reimagined
	void setMissionType(int iNewType);

	int getBonusProduced() const;					// Exposed to Python
	int getEnablesSpread() const; // Civ4 Reimagined
...
protected:
	...
	int m_iEnablesSpread; // Civ4 Reimagined
	int m_iNumBonuses; // Civ4 Reimagined
	bool m_bIsCoastal; // Civ4 Reimagined
	bool m_bCorpSlaves; // Civ4 Reimagined
...
public:
	...
	int getPrereqTech() const; // Civ4 Reimagined
	int getHealth() const;				// Exposed to Python
	int getHappiness() const;				// Exposed to Python
	...
	int getBuildingProductionModifier() const; // Civ4 Reimagined
	int getDistanceMaintenanceModifier() const; // Civ4 Reimagined
	int getBonusValueModifier() const; // Civ4 Reimagined
	int getVassalCommerceGain() const; // Civ4 Reimagined
	bool isNoPillage() const; // Civ4 Reimagined
	...
	int getCommerceChange(int i) const;				// Exposed to Python
	int getCommerceModifier(int i) const;				// Exposed to Python
	int getFreeCommerce(int i) const; // Civ4 Reimagined
...
protected:
	...
	int m_iPrereqTech; // Civ4 Reimagined
	int m_iHealth;													
	int m_iHappiness;
	int m_iMaxAnarchy;											
	...
	bool m_bIsNoPillage; // Civ4 Reimagined
	...
	int* m_paiFreeCommerce; //Civ4 Reimagined
