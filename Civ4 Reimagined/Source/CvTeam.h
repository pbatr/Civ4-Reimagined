...
/********************************************************************************/
	...
	int getDefensivePower(TeamTypes eExcludeTeam = NO_TEAM, bool bConquest = true) const;	// Exposed to Python
...
/************************************************************************************************/
	...
	bool isDefensiveWar(TeamTypes eIndex) const; // Civ4 Reimagined
	void setDefensiveWar(TeamTypes eIndex, bool bNewValue); // Civ4 Reimagined
	
	int getDefensiveWarWeariness() const; // Civ4 Reimagined - partial implementation
	void changeDefensvieWarWeariness(int iChange); // Civ4 Reimagined - partial implementation
...
/************************************************************************************************/
	...
	bool isCanFarmHills() const;
	void changeCanFarmHillsCount(int iChange);
...
protected:
	...
	bool* m_abAtWar;
	bool* m_abDefensiveWar; // Civ4 Reimagined
	bool* m_abHasMet;
