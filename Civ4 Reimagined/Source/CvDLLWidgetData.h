...
//	void parsePopupQueue(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
	...
	void parseSlaveryBarHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer);
	void parseInstabilityProgressBarHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer); // Civ4 Reimagined
	...
	void parseSeaPlotYieldHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer); // Civ4 Reimagined
	void parseIdeologiesHelp(CvWidgetDataStruct &widgetDataStruct, CvWStringBuffer &szBuffer); // Civ4 Reimagined
