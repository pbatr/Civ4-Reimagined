...
/********************************************************************************/
		...
		.def("changePoliticalInstabilityProgress", &CyPlayer::changePoliticalInstabilityProgress, "void (int iChange)")
		.def("getEconomicInstabilityProgress", &CyPlayer::getEconomicInstabilityProgress, "int ()")
		.def("changeEconomicInstabilityProgress", &CyPlayer::changeEconomicInstabilityProgress, "void (int iChange)")
