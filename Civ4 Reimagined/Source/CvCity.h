...
public:
	...
	//Civ4 Reimagined
	int countNumWaterPlots(bool bIgnoreCulture = false, bool bCountLakes = false) const;																					// Exposed to Python
	...
	void addProductionExperience(CvUnit* pUnit, bool bLessXP = false);		// Exposed to Python
	...
	int getColonyPercentAnger() const; // Civ4 Reimagined
	...
	// Civ4 Reimagined
	int getDistanceToCapital() const;
...
// BUG - Specialist Additional Great People - end
	...
	// Civ4 Reimagined
	int getNumBuildingsAtDoTurn() const;
	void setNumBuildingsAtDoTurn(int iValue);
...
// BUG - Building Saved Maintenance - end
	...
	int calculateColonyMaintenance(bool bIgnorePlayerMod = false) const; // Civ4 Reimagined
	...
	int calculateColonyMaintenanceTimes100(bool bIgnorePlayerMod = false) const; // Civ4 Reimagined
...
// BUG - Actual Effects - end
	...
	void changeBonusGoodHealth(double dChange); // Civ4 Reimagined
	void changeBonusBadHealth(double dChange); // Civ4 Reimagined
	void setBonusGoodHealth(double dChange); // Civ4 Reimagined
	void setBonusBadHealth(double dChange); // Civ4 Reimagined
...
/************************************************************************************************/
	...
	void changeBonusGoodHappiness(double dChange);	// Civ4 Reimagined
	void changeBonusBadHappiness(double dChange);	// Civ4 Reimagined
	void setBonusGoodHappiness(double dChange);	// Civ4 Reimagined
	void setBonusBadHappiness(double dChange);	// Civ4 Reimagined
...
*/
	...
	int getBonusUnitProductionModifier(BonusTypes eIndex) const;
	...
	// Civ4 Reimagined
	int getOverseaTradeRouteModifier() const;
	void changeOverseaTradeRouteModifier(int iChange);
...
// BUG - Specialist Additional Yield - end
	...
	int getBonusCommerceRateModifier(CommerceTypes eIndex) const; // Civ4 Reimagined
	void changeBonusCommerceRateModifier(CommerceTypes eIndex, int iChange); // Civ4 Reimagined
	...
	int calculateTradeProfitTimes100(CvCity* pCity) const; // Civ4 Reimagined								// Exposed to Python
...
// BUG - Specialist Additional Commerce - end
	...
	int getNumBonusesInFatCross(BonusTypes eIndex, bool bIgnoreCulture = true) const; // Civ4 Reimagined
	void changeNumBonusesInFatCross(BonusTypes eIndex, int iChange); // Civ4 Reimagined
	int getNumTerrainTypesInFatCross(TerrainTypes eIndex, bool bIgnoreCulture = true) const; // Civ4 Reimagined
	...
	// Civ4 Reimagined
	int restrictedGrowth(int numCities, int cap) const;
...
protected:
	...
	int m_iNumBuildings;
	int m_iNumBuildingsAtDoTurn; // Civ4 Reimagined
	...
	double m_dBonusGoodHealth; // Civ4 Reimagined
	double m_dBonusBadHealth; // Civ4 Reimagined
	...
	double m_dBonusGoodHappiness; // Civ4 Reimagined
	double m_dBonusBadHappiness; // Civ4 Reimagined
	...
	int* m_paiNumBonusesInFatCross; // Civ4 Reimagined
	int* m_paiNumTerrainTypesInFatCross; // Civ4 Reimagined
	int* m_paiNumPlotTypesInFatCross; // Civ4 Reimagined
	int* m_paiBonusUnitProductionModifier; // Civ4 Reimagined
	int* m_paiBonusBuildingProductionModifier; // Civ4 Reimagined
...
protected:
	...
	void doDecay();
	void doCorporation(); // Civ4 Reimagined
	void doReligion();
	void doGreatPeople();
	void doMeltdown();
	...
	int getHurryCostModifier(ProjectTypes eProject, bool bIgnoreNew) const; // Civ4 Reimagined
	...
	int getHurryCost(bool bExtra, ProjectTypes eProject, bool bIgnoreNew) const; // Civ4 Reimagined
