...
m_iGridX(0),
m_iGridY(0),
m_iCoastBonusCommerce(0), // Civ4 Reimagined
m_bRepeat(false),
m_bTrade(false),
m_bDisable(false),
m_bGoodyTech(false),
...
// Civ4 Reimagined
int CvTechInfo::getCoastBonusCommerce() const			
{
	return m_iCoastBonusCommerce;
}
...
void CvTechInfo::read(FDataStreamBase* stream)
{
	...
	stream->Read(&m_iCoastBonusCommerce); // Civ4 Reimagined
...
void CvTechInfo::write(FDataStreamBase* stream)
{
	...
	stream->Write(m_iCoastBonusCommerce); // Civ4 Reimagined
...
bool CvTechInfo::read(CvXMLLoadUtility* pXML)
{
	...
	pXML->GetChildXmlValByName(&m_iCoastBonusCommerce, "iCoastBonusCommerce"); // Civ4 Reimagined
...
m_iPrereqCivic(NO_CIVIC), // Civ4 Reimagined
...
m_bNoUpkeep(false), // Civ4 Reimagined
m_bPillage(false),
m_bSpy(false),
m_bSabotage(false),
m_bDestroy(false),
...
m_bBlitz(false), // Civ4 Reimagined
...
{
	// Civ4 Reimagined
	return (int)std::pow((double)m_iPowerValue, 1.22);
}
...
void CvUnitInfo::read(FDataStreamBase* stream)
{
	...
	stream->Read(&m_iPrereqCivic); //Civ4 Reimagined
	...
	stream->Read(&m_bNoUpkeep); // Civ4 Reimagined
	...
	stream->Read(&m_bBlitz); // Civ4 Reimagined
...
void CvUnitInfo::write(FDataStreamBase* stream)
{
	...
	stream->Write(m_iPrereqCivic); //Civ4 Reimagined
	...
	stream->Write(m_bNoUpkeep); // Civ4 Reimagined
	...
	stream->Write(m_bBlitz); // Civ4 Reimagined
...
bool CvUnitInfo::read(CvXMLLoadUtility* pXML)
{
	...
	pXML->GetChildXmlValByName(&m_bNoUpkeep, "bNoUpkeep"); // Civ4 Reimagined
	...
	pXML->GetChildXmlValByName(&m_bBlitz, "bBlitz"); // Civ4 Reimagined
...
m_bNoGreatPeople(false), // Civ4 Reimagined
m_bNoCultureFlip(false), // Civ4 Reimagined
...
m_bNoCapital(false), // Civ4 Reimagined
m_iCorporationMaintenanceModifier(0),
m_iCorporationCommerceModifier(0), //Leoreth
m_iProcessModifier(0), //Leoreth
m_iExtraHappiness(0), // Civ4 Reimagined
m_bNoCapitalUnhappiness(false), // Civ4 Reimagined
m_iExtraHealth(0),
...
m_bNoForeignCultureUnhappiness(false), // Civ4 Reimagined
m_bNoCityResistance(false), // Civ4 Reimagined
m_iProductionPerSurplusHappiness(0), // Civ4 Reimagined
m_iWonderProductionBonus(0), // Civ4 Reimagined
...
m_iForeignUnitSupply(0), //Civ4 Reimagined
m_iPillageGainModifier(0), //Civ4 Reimagined
m_iBonusRatioModifier(0), //Civ4 Reimagined
...
m_piCapitalCommerceModifierPerHappinessSurplus(NULL), // Civ4 Reimagined
m_piExtraCommerceHappiness(NULL), // Civ4 Reimagined
m_piStateReligionBuildingCommerce(NULL), // Civ4 Reimagined
...
//m_paszHostileCivicText(NULL), // Civ4 Reimagined
m_pabHurry(NULL),
m_pabSpecialBuildingNotRequired(NULL),
m_pabSpecialistValid(NULL),
m_paiExtraSpecialists(NULL), // Civ4 Reimagined
m_ppiSpecialistYieldChanges(NULL), // Civ4 Reimagined
m_ppiSpecialistCommerceChanges(NULL), // Civ4 Reimagined
m_ppiImprovementYieldChanges(NULL),
m_ppiRadiusImprovementCommerceChanges(NULL), // Civ4 Reimagined
m_ppiBuildingYieldChanges(NULL) // Civ4 Reimagined
{
}
...
CvCivicInfo::~CvCivicInfo()
{
	...
	SAFE_DELETE_ARRAY(m_piCapitalCommerceModifierPerHappinessSurplus); // Civ4 Reimagined
	SAFE_DELETE_ARRAY(m_piExtraCommerceHappiness); // Civ4 Reimagined
	SAFE_DELETE_ARRAY(m_piStateReligionBuildingCommerce); // Civ4 Reimagined
	...
	// Civ4 Reimagined
	if (m_ppiRadiusImprovementCommerceChanges != NULL)
	{
		for (iI=0;iI<GC.getNumImprovementInfos();iI++)
		{
			SAFE_DELETE_ARRAY(m_ppiRadiusImprovementCommerceChanges[iI]);
		}
		SAFE_DELETE_ARRAY(m_ppiRadiusImprovementCommerceChanges);
	}
	// Civ4 Reimagined
...
// Civ4 Reimagined
bool CvCivicInfo::isNoGreatPeople() const	
{
	return m_bNoGreatPeople;
}

// Civ4 Reimagined
bool CvCivicInfo::isNoCultureFlip() const	
{
	return m_bNoCultureFlip;
}
...
// Civ4 Reimagined
bool CvCivicInfo::isNoCapital() const
{
	return m_bNoCapital;
}
...
// Civ4 Reimagined
int CvCivicInfo::getExtraHappiness() const
{
...
// Civ4 Reimagined
int CvCivicInfo::getGoldPerHappinessBonus() const
{
...
// Civ4 Reimagined
bool CvCivicInfo::isNoForeignCultureUnhappiness() const
{
	return m_bNoForeignCultureUnhappiness;
}

// Civ4 Reimagined
bool CvCivicInfo::isNoCityResistance() const
{
	return m_bNoCityResistance;
}

// Civ4 Reimagined
int CvCivicInfo::getProductionPerSurplusHappiness() const
{
	return m_iProductionPerSurplusHappiness;
}

// Civ4 Reimagined
int CvCivicInfo::getWonderProductionBonus() const
{
	return m_iWonderProductionBonus;
}
...
// Civ4 Reimagined
bool CvCivicInfo::enablesSlaves() const
{
	return m_bSlaves;
}

// Civ4 Reimagined
bool CvCivicInfo::isNoMilitaryProductionMali() const
{
	return m_bNoMilitaryProductionMali;
}

// Civ4 Reimagined
bool CvCivicInfo::isNoUnitSupply() const
{
	return m_bNoUnitSupply;
}
...
// Civ4 Reimagined
int CvCivicInfo::getDomesticTradeModifier() const
{
	return m_iDomesticTradeModifier;
}

// Civ4 Reimagined
int CvCivicInfo::getColonyTradeModifier() const
{
...
// Civ4 Reimagined
int CvCivicInfo::getUnitUpgradeCostModifier() const
{
	return m_iUnitUpgradeCostModifier;
}

// Civ4 Reimagined
int CvCivicInfo::getForeignUnitSupply() const
{
	return m_iForeignUnitSupply;
}

// Civ4 Reimagined
int CvCivicInfo::getPillageGainModifier() const
{
	return m_iPillageGainModifier;
}

// Civ4 Reimagined
int CvCivicInfo::getBonusRatioModifier() const
{
	return m_iBonusRatioModifier;
}

// Civ4 Reimagined
int CvCivicInfo::getResearchPerCulture() const
{
...
// Civ4 Reimagined
bool CvCivicInfo::isUnlimitedAnimalXP() const
{
	return m_bUnlimitedAnimalXP;
}
...
//Leoreth
int CvCivicInfo::getPopulationUnhappinessModifier() const
{
...
// Civ4 Reimagined
int CvCivicInfo::getExtraYield(int i) const
{
	FAssertMsg(i < NUM_YIELD_TYPES, "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	return m_piExtraYield ? m_piExtraYield[i] : -1;
}

// Civ4 Reimagined
int* CvCivicInfo::getExtraYieldArray() const
{
	return m_piExtraYield;
}

// Civ4 Reimagined
int CvCivicInfo::getCapitalExtraYieldFromCityPercent(int i) const
{
	FAssertMsg(i < NUM_YIELD_TYPES, "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	return m_piCapitalExtraYieldFromCityPercent ? m_piCapitalExtraYieldFromCityPercent[i] : -1;
}

// Civ4 Reimagined
int* CvCivicInfo::getCapitalExtraYieldFromCityPercentArray() const
{
	return m_piCapitalExtraYieldFromCityPercent;
}
...
// Civ4 Reimagined
int CvCivicInfo::getCapitalCommerceModifierPerHappinessSurplus(int i) const
{
	FAssertMsg(i < NUM_COMMERCE_TYPES, "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	return m_piCapitalCommerceModifierPerHappinessSurplus ? m_piCapitalCommerceModifierPerHappinessSurplus[i] : -1;
}

// Civ4 Reimagined
int* CvCivicInfo::getCapitalCommerceModifierPerHappinessSurplusArray() const
{
	return m_piCapitalCommerceModifierPerHappinessSurplus;
}

// Civ4 Reimagined
int CvCivicInfo::getExtraCommerceHappiness(int i) const
{
	FAssertMsg(i < NUM_COMMERCE_TYPES, "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	return m_piExtraCommerceHappiness ? m_piExtraCommerceHappiness[i] : -1;
}

// Civ4 Reimagined
int* CvCivicInfo::getExtraCommerceHappinessArray() const
{
	return m_piExtraCommerceHappiness;
}

// Civ4 Reimagined
int CvCivicInfo::getStateReligionBuildingCommerce(int i) const
{
	FAssertMsg(i < NUM_COMMERCE_TYPES, "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	return m_piStateReligionBuildingCommerce ? m_piStateReligionBuildingCommerce[i] : -1;
}

// Civ4 Reimagined
int* CvCivicInfo::getStateReligionBuildingCommerceArray() const
{
	return m_piStateReligionBuildingCommerce;
}
...
// Civ4 Reimagined
int CvCivicInfo::getExtraSpecialists(int i) const							
{
	FAssertMsg(i < GC.getNumSpecialistInfos(), "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	return m_paiExtraSpecialists ? m_paiExtraSpecialists[i] : -1;
}
...
int CvCivicInfo::getSpecialistCommerceChanges(int i, int j) const
{
	...
	FAssertMsg(j > -1, "Index out of bounds");
	return m_ppiSpecialistCommerceChanges[i][j];
}
...
// Civ4 Reimagined
int CvCivicInfo::getRadiusImprovementCommerceChanges(int i, int j) const
{
	FAssertMsg(i < GC.getNumImprovementInfos(), "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	FAssertMsg(j < NUM_COMMERCE_TYPES, "Index out of bounds");
	FAssertMsg(j > -1, "Index out of bounds");
	return m_ppiRadiusImprovementCommerceChanges[i][j];
}
...
void CvCivicInfo::read(FDataStreamBase* stream)
{
	...
	stream->Read(&m_iColonyMaintenanceModifier); // Civ4 Reimagined
	...
	stream->Read(&m_iExtraHappiness); // Civ4 Reimagined
	stream->Read(&m_bNoCapitalUnhappiness); // Civ4 Reimagined
	stream->Read(&m_iExtraHealth);
	stream->Read(&m_iPollutionModifier); //Leoreth
	stream->Read(&m_iPopulationUnhappinessModifier); //Civ4 Reimagined
	...
	stream->Read(&m_iGoldPerHappinessBonus); // Civ4 Reimagined
	...
	stream->Read(&m_bNoForeignCultureUnhappiness); //Civ4 Reimagined
	stream->Read(&m_bNoCityResistance); //Civ4 Reimagined
	stream->Read(&m_iProductionPerSurplusHappiness); //Civ4 Reimagined
	stream->Read(&m_iWonderProductionBonus); //Civ4 Reimagined
	...
	stream->Read(&m_iDomesticTradeModifier); //Civ4 Reimagined
	stream->Read(&m_iColonyTradeModifier); //Civ4 Reimagined
	stream->Read(&m_iCapitalTradeModifier); //Civ4 Reimagined
	stream->Read(&m_iUnitUpgradeCostModifier); //Civ4 Reimagined
	stream->Read(&m_iForeignUnitSupply); //Civ4 Reimagined
	stream->Read(&m_iPillageGainModifier); //Civ4 Reimagined
	...
	stream->Read(&m_bUnlimitedAnimalXP); // Civ4 Reimagined
	...
	m_piExtraYield = new int[NUM_YIELD_TYPES];
	stream->Read(NUM_YIELD_TYPES, m_piExtraYield);
	
	// Civ4 Reimagined
	SAFE_DELETE_ARRAY(m_piCapitalExtraYieldFromCityPercent);
	m_piCapitalExtraYieldFromCityPercent = new int[NUM_YIELD_TYPES];
	stream->Read(NUM_YIELD_TYPES, m_piCapitalExtraYieldFromCityPercent);
	...
	// Civ4 Reimagined
	SAFE_DELETE_ARRAY(m_piCapitalCommerceModifierPerHappinessSurplus);
	m_piCapitalCommerceModifierPerHappinessSurplus = new int[NUM_COMMERCE_TYPES];
	stream->Read(NUM_COMMERCE_TYPES, m_piCapitalCommerceModifierPerHappinessSurplus);
	
	// Civ4 Reimagined
	SAFE_DELETE_ARRAY(m_piExtraCommerceHappiness);
	m_piExtraCommerceHappiness = new int[NUM_COMMERCE_TYPES];
	stream->Read(NUM_COMMERCE_TYPES, m_piExtraCommerceHappiness);
	
	// Civ4 Reimagined
	SAFE_DELETE_ARRAY(m_piStateReligionBuildingCommerce);
	m_piStateReligionBuildingCommerce = new int[NUM_COMMERCE_TYPES];
	stream->Read(NUM_COMMERCE_TYPES, m_piStateReligionBuildingCommerce);
	...
	// Civ4 Reimagined
	SAFE_DELETE_ARRAY(m_paiExtraSpecialists);
	m_paiExtraSpecialists = new int[GC.getNumSpecialistInfos()];
	stream->Read(GC.getNumSpecialistInfos(), m_paiExtraSpecialists);
	...
	if (m_ppiRadiusImprovementCommerceChanges != NULL)
	{
		for(i=0;i<GC.getNumImprovementInfos();i++)
		{
			SAFE_DELETE_ARRAY(m_ppiRadiusImprovementCommerceChanges[i]);
		}
		SAFE_DELETE_ARRAY(m_ppiRadiusImprovementCommerceChanges);
	}
	m_ppiRadiusImprovementCommerceChanges = new int*[GC.getNumImprovementInfos()];
	for(i=0;i<GC.getNumImprovementInfos();i++)
	{
		m_ppiRadiusImprovementCommerceChanges[i]  = new int[NUM_COMMERCE_TYPES];
		stream->Read(NUM_YIELD_TYPES, m_ppiRadiusImprovementCommerceChanges[i]);
	}
	...
	m_ppiBuildingYieldChanges = new int*[GC.getNumBuildingClassInfos()];
	for(i=0;i<GC.getNumBuildingClassInfos();i++)
	{
...
void CvCivicInfo::write(FDataStreamBase* stream)
{
	...
	stream->Write(m_iColonyMaintenanceModifier); // Civ4 Reimagined
	...
	stream->Write(m_iExtraHappiness); // Civ4 Reimagined
	stream->Write(m_bNoCapitalUnhappiness); // Civ4 Reimagined
	stream->Write(m_iExtraHealth);
	stream->Write(m_iPollutionModifier); //Leoreth
	stream->Write(m_iPopulationUnhappinessModifier); //Civ4 Reimagined
	...
	stream->Write(m_iGoldPerHappinessBonus); // Civ4 Reimagined
	...
	stream->Write(m_bNoForeignCultureUnhappiness); //Civ4 Reimagined
	stream->Write(m_bNoCityResistance); //Civ4 Reimagined
	stream->Write(m_iProductionPerSurplusHappiness); //Civ4 Reimagined
	stream->Write(m_iWonderProductionBonus); //Civ4 Reimagined
	...
	stream->Write(m_iDomesticTradeModifier); //Civ4 Reimagined
	stream->Write(m_iColonyTradeModifier); //Civ4 Reimagined
	stream->Write(m_iCapitalTradeModifier); //Civ4 Reimagined
	stream->Write(m_iUnitUpgradeCostModifier); //Civ4 Reimagined
	stream->Write(m_iForeignUnitSupply); //Civ4 Reimagined
	stream->Write(m_iPillageGainModifier); //Civ4 Reimagined
	...
	stream->Write(m_bUnlimitedAnimalXP); // Civ4 Reimagined
	...
	stream->Write(NUM_COMMERCE_TYPES, m_piCapitalCommerceModifierPerHappinessSurplus); // Civ4 Reimagined
	stream->Write(NUM_COMMERCE_TYPES, m_piExtraCommerceHappiness); //Civ4 Reimagined
	stream->Write(NUM_COMMERCE_TYPES, m_piStateReligionBuildingCommerce); //Civ4 Reimagined
	...
	stream->Write(GC.getNumSpecialistInfos(), m_paiExtraSpecialists); // Civ4 Reimagined
	...
	for(i=0;i<GC.getNumImprovementInfos();i++)
	{
		stream->Write(NUM_COMMERCE_TYPES, m_ppiRadiusImprovementCommerceChanges[i]);
	}
...
bool CvCivicInfo::read(CvXMLLoadUtility* pXML)
{
	...
	pXML->GetChildXmlValByName(&m_bNoGreatPeople, "bNoGreatPeople"); //Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_bNoCultureFlip, "bNoCultureFlip"); //Civ4 Reimagined
	...
	pXML->GetChildXmlValByName(&m_iColonyMaintenanceModifier, "iColonyMaintenanceModifier"); // Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_bNoCapital, "bNoCapital"); //Civ4 Reimagined
	...
	pXML->GetChildXmlValByName(&m_iExtraHappiness, "iExtraHappiness"); // Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_bNoCapitalUnhappiness, "bNoCapitalUnhappiness"); // Civ4 Reimagined
	...
	pXML->GetChildXmlValByName(&m_iPopulationUnhappinessModifier, "iPopulationUnhappinessModifier"); //Civ4 Reimagined
	...
	pXML->GetChildXmlValByName(&m_iGoldPerHappinessBonus, "iGoldPerHappinessBonus"); // Civ4 Reimagined
	...
	pXML->GetChildXmlValByName(&m_iTradeRoutes, "iTradeRoutes");
	pXML->GetChildXmlValByName(&m_iDomesticTradeModifier, "iDomesticTradeModifier"); //Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_iColonyTradeModifier, "iColonyTradeModifier"); //Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_iCapitalTradeModifier, "iCapitalTradeModifier"); //Civ4 Reimagined
	...
	pXML->GetChildXmlValByName(&m_bUnlimitedAnimalXP, "bUnlimitedAnimalXP"); //Civ4 Reimagined
	...
	pXML->GetChildXmlValByName(&m_bNoForeignCultureUnhappiness, "bNoForeignCultureUnhappiness"); //Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_bNoCityResistance, "bNoCityResistance"); //Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_iProductionPerSurplusHappiness, "iProductionPerSurplusHappiness"); //Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_iUnitUpgradeCostModifier, "iUnitUpgradeCostModifier"); //Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_iForeignUnitSupply, "iForeignUnitSupply"); //Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_iPillageGainModifier, "iPillageGainModifier"); //Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_iBonusRatioModifier, "iBonusRatioModifier"); //Civ4 Reimagined
	...
	// Civ4 Reimagined
	if (gDLL->getXMLIFace()->SetToChildByTagName(pXML->GetXML(),"ExtraYields"))
	{
		pXML->SetYields(&m_piExtraYield);
		gDLL->getXMLIFace()->SetToParent(pXML->GetXML());
	}
	else
	{
		pXML->InitList(&m_piExtraYield, NUM_YIELD_TYPES);
	}
	
	// Civ4 Reimagined
	if (gDLL->getXMLIFace()->SetToChildByTagName(pXML->GetXML(),"CapitalExtraYieldFromCityPercent"))
	{
		pXML->SetYields(&m_piCapitalExtraYieldFromCityPercent);
		gDLL->getXMLIFace()->SetToParent(pXML->GetXML());
	}
	else
	{
		pXML->InitList(&m_piCapitalExtraYieldFromCityPercent, NUM_YIELD_TYPES);
	}
	...
	// Civ4 Reimagined
	if (gDLL->getXMLIFace()->SetToChildByTagName(pXML->GetXML(),"CapitalCommerceModifiersPerHappinessSurplus"))
	{
		pXML->SetCommerce(&m_piCapitalCommerceModifierPerHappinessSurplus);
		gDLL->getXMLIFace()->SetToParent(pXML->GetXML());
	}
	else
	{
		pXML->InitList(&m_piCapitalCommerceModifierPerHappinessSurplus, NUM_COMMERCE_TYPES);
	}
	
	// Civ4 Reimagined
	if (gDLL->getXMLIFace()->SetToChildByTagName(pXML->GetXML(),"ExtraCommerceHappiness"))
	{
		pXML->SetCommerce(&m_piExtraCommerceHappiness);
		gDLL->getXMLIFace()->SetToParent(pXML->GetXML());
	}
	else
	{
		pXML->InitList(&m_piExtraCommerceHappiness, NUM_COMMERCE_TYPES);
	}
	
	// Civ4 Reimagined
	if (gDLL->getXMLIFace()->SetToChildByTagName(pXML->GetXML(),"StateReligionBuildingCommerces"))
	{
		pXML->SetCommerce(&m_piStateReligionBuildingCommerce);
		gDLL->getXMLIFace()->SetToParent(pXML->GetXML());
	}
	else
	{
		pXML->InitList(&m_piStateReligionBuildingCommerce, NUM_COMMERCE_TYPES);
	}
	...
	// Civ4 Reimagined
	pXML->SetVariableListTagPair(&m_paiExtraSpecialists, "ExtraSpecialists", sizeof(GC.getSpecialistInfo((SpecialistTypes)0)), GC.getNumSpecialistInfos());
	...
	// Civ4 Reimagined
	FAssertMsg((GC.getNumImprovementInfos() > 0) && (NUM_COMMERCE_TYPES) > 0,"either the number of improvement infos is zero or less or the number of commerce types is zero or less");
	pXML->Init2DIntList(&m_ppiRadiusImprovementCommerceChanges, GC.getNumImprovementInfos(), NUM_COMMERCE_TYPES);
	if (gDLL->getXMLIFace()->SetToChildByTagName(pXML->GetXML(),"RadiusImprovementCommerceChanges"))
	{
		if (pXML->SkipToNextVal())
		{
			iNumSibs = gDLL->getXMLIFace()->GetNumChildren(pXML->GetXML());
			if (gDLL->getXMLIFace()->SetToChild(pXML->GetXML()))
			{
				if (0 < iNumSibs)
				{
					for (j=0;j<iNumSibs;j++)
					{
						...
						{
							// delete the array since it will be reallocated
							SAFE_DELETE_ARRAY(m_ppiRadiusImprovementCommerceChanges[iIndex]);
							// if we can set the current xml node to it's next sibling
							if (gDLL->getXMLIFace()->SetToChildByTagName(pXML->GetXML(),"ImprovementCommerce"))
							{
								// call the function that sets the yield change variable
								pXML->SetYields(&m_ppiRadiusImprovementCommerceChanges[iIndex]);
								gDLL->getXMLIFace()->SetToParent(pXML->GetXML());
							}
							else
							{
								pXML->InitList(&m_ppiRadiusImprovementCommerceChanges[iIndex], NUM_COMMERCE_TYPES);
							}
						}
	...
	// Civ4 Reimagined
	FAssertMsg((GC.getNumBuildingClassInfos() > 0) && (NUM_YIELD_TYPES) > 0,"either the number of buildingclass infos is zero or less or the number of yield types is zero or less");
...
m_iFreeUnitClass(NO_UNITCLASS), // Civ4 Reimagined
...
//m_iDefenseWarWearinessModifier(0), // Civ4 Reimagined
m_iHealRateChange(0),
m_iHealth(0),
m_iAreaHealth(0),
m_iGlobalHealth(0),
...
m_iTargetAirStrike(0), //Civ4 Reimagined
m_iLootingModifier(0), // Civ4 Reimagined
m_iStateReligionFreeExperience(0), // Civ4 Reimagined
m_iNavalLevelPrereq(0), // Civ4 Reimagined
...
m_bPrereqPowerOr(false), // Civ4 Reimagined
m_bPrereqPowerAnd(false), // Civ4 Reimagined
...
m_bCanFarmHills(false), // Civ4 Reimagined
m_bUnlimitedBarbXP(false), // Civ4 Reimagined
...
m_piCommerceFromAirlift(NULL), // Civ4 Reimagined
m_piCommerceModifier(NULL),
...
m_piBonusUnitProductionModifiers(NULL), // Civ4 Reimagined
m_piBonusBuildingProductionModifiers(NULL), // Civ4 Reimagined
m_piBonusProductionModifier(NULL),
...
m_ppaiBonusCommerceModifier(NULL), // Civ4 Reimagined
m_bAnySpecialistYieldChange(false),
m_bAnyBonusYieldModifier(false),
m_bAnyBonusCommerceModifier(false), // Civ4 Reimagined
/************************************************************************************************/
...
CvBuildingInfo::~CvBuildingInfo()
{
	...
	SAFE_DELETE_ARRAY(m_piCommerceFromAirlift); // Civ4 Reimagined
	SAFE_DELETE_ARRAY(m_piCommerceModifier);
	...
	SAFE_DELETE_ARRAY(m_piBonusUnitProductionModifiers); // Civ4 Reimagined
	SAFE_DELETE_ARRAY(m_piBonusBuildingProductionModifiers); // Civ4 Reimagined
	SAFE_DELETE_ARRAY(m_piBonusProductionModifier);
...
// Civ4 Reimagined
int CvBuildingInfo::getNoAnarchyCivicOption() const
{
	return m_iNoAnarchyCivicOption;
}
...
// Civ4 Reimagined
int CvBuildingInfo::getOverseaTradeRouteModifier() const
{
...
// Civ4 Reimagined
int CvBuildingInfo::getBonusFatCross() const		
{
	return m_iBonusFatCross;
}

// Civ4 Reimagined
int CvBuildingInfo::getPlotTypeFatCross() const		
{
	return m_iPlotTypeFatCross;
}
...
// Civ4 Reimagined
//int CvBuildingInfo::getDefenseWarWearinessModifier() const
//{
//	return m_iDefenseWarWearinessModifier;
//}
...
// Civ4 Reimagined
int CvBuildingInfo::getTargetAirStrike() const	
{
	return m_iTargetAirStrike;
}
...
// Civ4 Reimagined
bool CvBuildingInfo::isFlatlands() const
{
	return m_bFlatlands;
}
...
// Civ4 Reimagined
bool CvBuildingInfo::isPrereqPowerOr() const
{
	return m_bPrereqPowerOr;
}

// Civ4 Reimagined
bool CvBuildingInfo::isPrereqPowerAnd() const
{
	return m_bPrereqPowerAnd;
}
...
// Civ4 Reimagined
bool CvBuildingInfo::isUnlimitedBarbXP() const
{
	return m_bUnlimitedBarbXP;
}

// Civ4 Reimagined
bool CvBuildingInfo::isBarbarianGreatGeneral() const
{
	return m_bBarbarianGreatGeneral;
}

// Civ4 Reimagined
bool CvBuildingInfo::isCanFarmHills() const
{
	return m_bCanFarmHills;
}

// Civ4 Reimagined
bool CvBuildingInfo::isNoWarAgainstSameFaithUnhappiness() const
{
	return m_bNoWarAgainstSameFaithUnhappiness;
}

// Civ4 Reimagined
int CvBuildingInfo::getReligionSpreadBoost() const
{
	return m_iReligionSpreadBoost;
}
...
// Civ4 Reimagined
int CvBuildingInfo::getLootingModifier() const
{
	return m_iLootingModifier;
}

// Civ4 Reimagined
int CvBuildingInfo::getStateReligionFreeExperience() const
{
	return m_iStateReligionFreeExperience;
}

// Civ4 Reimagined
int CvBuildingInfo::getNavalLevelPrereq() const
{
	return m_iNavalLevelPrereq;
}
...
// Civ4 Reimagined
bool CvBuildingInfo::isNoConquestResistance() const
{
...
// Civ4 Reimagined
int CvBuildingInfo::getCommercePerCultureLevel(int i) const			
{
	FAssertMsg(i < NUM_COMMERCE_TYPES, "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	return m_piCommercePerCultureLevel ? m_piCommercePerCultureLevel[i] : -1;
}

// Civ4 Reimagined
int* CvBuildingInfo::getCommercePerCultureLevelArray() const
{
	return m_piCommercePerCultureLevel;
}
...
int CvBuildingInfo::getCommerceFromCoast(int i) const			
{
	FAssertMsg(i < NUM_COMMERCE_TYPES, "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	return m_piCommerceFromCoast ? m_piCommerceFromCoast[i] : -1;
}

// Civ4 Reimagined
int* CvBuildingInfo::getCommerceFromCoastArray() const
{
	return m_piCommerceFromCoast;
}

// Civ4 Reimagined
int CvBuildingInfo::getCommerceFromAirlift(int i) const			
{
	FAssertMsg(i < NUM_COMMERCE_TYPES, "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	return m_piCommerceFromAirlift ? m_piCommerceFromAirlift[i] : -1;
}

// Civ4 Reimagined
int* CvBuildingInfo::getCommerceFromAirliftArray() const
{
	return m_piCommerceFromAirlift;
}
...
// Civ4 Reimagined
int CvBuildingInfo::getBonusUnitProductionModifier(int i) const
{
	FAssertMsg(i < GC.getNumBonusInfos(), "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	return m_piBonusUnitProductionModifiers ? m_piBonusUnitProductionModifiers[i] : -1;
}

// Civ4 Reimagined
int CvBuildingInfo::getBonusBuildingProductionModifier(int i) const
{
	FAssertMsg(i < GC.getNumBonusInfos(), "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	return m_piBonusBuildingProductionModifiers ? m_piBonusBuildingProductionModifiers[i] : -1;
}
...
// Civ4 Reimagined
int CvBuildingInfo::getPercentPrereqNumOfBuildingClass(int i) const
{
	FAssertMsg(i < GC.getNumBuildingClassInfos(), "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	return m_piPercentPrereqNumOfBuildingClass ? m_piPercentPrereqNumOfBuildingClass[i] : -1;
}
...
// Civ4 Reimagined
bool CvBuildingInfo::isAnyBonusCommerceModifier() const
{
	return m_bAnyBonusCommerceModifier;
}
/************************************************************************************************/
/* UNOFFICIAL_PATCH                        END                                                  */
/************************************************************************************************/
...
// Civ4 Reimagined 
bool CvBuildingInfo::isAnyTechYieldModifier() const
{
	return m_bAnyTechYieldModifier;
}
...
int CvBuildingInfo::getTechYieldModifier(int i, int j) const
{
	...
	FAssertMsg(j < NUM_YIELD_TYPES, "Index out of bounds");
	FAssertMsg(j > -1, "Index out of bounds");
	return m_ppaiTechYieldModifier ? m_ppaiTechYieldModifier[i][j] : -1;
}
...
// < Building Civic Prereqs Start >
bool CvBuildingInfo::isPrereqCivic(int i) const
{
	FAssertMsg(i < GC.getNumCivicInfos(), "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	return m_pbPrereqCivics ? m_pbPrereqCivics[i] : false;
}
// < Building Civic Prereqs End   >

// Civ4 Reimagined
bool CvBuildingInfo::hasPrereqCivics() const
{
	if (m_pbPrereqCivics)
	{
		for (int i = 0; i < GC.getNumCivicInfos(); i++)
		{
			if (m_pbPrereqCivics[i])
			{
				return true;
			}
		}
...
void CvBuildingInfo::read(FDataStreamBase* stream)
{
	...
	stream->Read(&m_iFreeUnitClass); // Civ4 Reimagined
	...
	stream->Read(&m_iOverseaTradeRouteModifier); // Civ4 Reimagined
	stream->Read(&m_iAssetValue);
	stream->Read(&m_iPowerValue);
	...
	stream->Read(&m_iPrereqAndBonus);
	stream->Read(&m_iBonusFatCross); // Civ4 Reimagined
	...
	//stream->Read(&m_iDefenseWarWearinessModifier); // Civ4 Reimagined
	...
	stream->Read(&m_iTargetAirStrike); //Civ4 Reimagined
	...
	stream->Read(&m_bPrereqPowerOr); // Civ4 Reimagined
	stream->Read(&m_bPrereqPowerAnd); // Civ4 Reimagined
	...
	stream->Read(&m_bUnlimitedBarbXP); // Civ4 Reimagined
	stream->Read(&m_bBarbarianGreatGeneral); // Civ4 Reimagined
	...
	// Civ4 Reimagined
	SAFE_DELETE_ARRAY(m_piCommercePerCultureLevel);
	m_piCommercePerCultureLevel = new int[NUM_COMMERCE_TYPES];
	...
	// Civ4 Reimagined
	SAFE_DELETE_ARRAY(m_piCommerceFromAirlift);
	m_piCommerceFromAirlift = new int[NUM_COMMERCE_TYPES];
	stream->Read(NUM_COMMERCE_TYPES, m_piCommerceFromAirlift);
	...
	// Civ4 Reimagined
	SAFE_DELETE_ARRAY(m_piBonusUnitProductionModifiers);
	m_piBonusUnitProductionModifiers = new int[GC.getNumBonusInfos()];
	stream->Read(GC.getNumBonusInfos(), m_piBonusUnitProductionModifiers);
	
	// Civ4 Reimagined
	SAFE_DELETE_ARRAY(m_piBonusBuildingProductionModifiers);
	m_piBonusBuildingProductionModifiers = new int[GC.getNumBonusInfos()];
	stream->Read(GC.getNumBonusInfos(), m_piBonusBuildingProductionModifiers);
	...
	// Civ4 Reimagined
	SAFE_DELETE_ARRAY(m_piPercentPrereqNumOfBuildingClass);
	m_piPercentPrereqNumOfBuildingClass = new int[GC.getNumBuildingClassInfos()];
	stream->Read(GC.getNumBuildingClassInfos(), m_piPercentPrereqNumOfBuildingClass);
...
/************************************************************************************************/
	...
	// Civ4 Reimagined
	m_bAnyBonusCommerceModifier = false;
	for(i=0;(!m_bAnyBonusCommerceModifier) && i<GC.getNumBonusInfos();i++)
	{
		for(int j=0; j < NUM_COMMERCE_TYPES; j++ )
		{
			if( m_ppaiBonusCommerceModifier[i][j] != 0 )
			{
				m_bAnyBonusCommerceModifier = true;
				break;
			}
		}
	}
...
/************************************************************************************************/
	...
	// Civ4 Reimagined
	m_bAnyTechYieldModifier = false;
	for(i=0;(!m_bAnyTechYieldModifier) && i<GC.getNumTechInfos();i++)
	{
		for(int j=0; j < NUM_YIELD_TYPES; j++ )
		{
			if( m_ppaiTechYieldModifier[i][j] != 0 )
			{
	...
	// < Building Civic Prereqs Start >
	SAFE_DELETE_ARRAY(m_pbPrereqCivics);
	m_pbPrereqCivics = new bool[GC.getNumCivicInfos()];
	stream->Read(GC.getNumCivicInfos(), m_pbPrereqCivics);
	// < Building Civic Prereqs End   >
}
...
void CvBuildingInfo::write(FDataStreamBase* stream)
{
	...
	stream->Write(m_iFreeUnitClass); // Civ4 Reimagined
	...
	stream->Write(m_iOverseaTradeRouteModifier); // Civ4 Reimagined
	stream->Write(m_iAssetValue);
	stream->Write(m_iPowerValue);
	...
	//stream->Write(m_iDefenseWarWearinessModifier); // Civ4 Reimagined
	...
	stream->Write(m_iTargetAirStrike);
	...
	stream->Write(m_bPrereqPowerOr); // Civ4 Reimagined
	stream->Write(m_bPrereqPowerAnd); // Civ4 Reimagined
	...
	stream->Write(m_bUnlimitedBarbXP); // Civ4 Reimagined
	stream->Write(m_bBarbarianGreatGeneral); // Civ4 Reimagined
	...
	stream->Write(NUM_COMMERCE_TYPES, m_piCommerceFromAirlift); // Civ4 Reimagined
	stream->Write(NUM_COMMERCE_TYPES, m_piCommerceModifier);
	...
	stream->Write(GC.getNumBonusInfos(), m_piBonusUnitProductionModifiers); // Civ4 Reimagined
	stream->Write(GC.getNumBonusInfos(), m_piBonusBuildingProductionModifiers); // Civ4 Reimagined
	stream->Write(GC.getNumBonusInfos(), m_piBonusProductionModifier);
	...
	// < Building Civic Prereqs Start >
	stream->Write(GC.getNumCivicInfos(), m_pbPrereqCivics);
	// < Building Civic Prereqs End   >
}
...
bool CvBuildingInfo::read(CvXMLLoadUtility* pXML)
{
	...
	// Civ4 Reimagined
	pXML->GetChildXmlValByName(szTextVal, "BonusFatCross");
	m_iBonusFatCross = pXML->FindInInfoClass(szTextVal);
	
	// Civ4 Reimagined
	pXML->GetChildXmlValByName(szTextVal, "PlotTypeFatCross");
	m_iPlotTypeFatCross = pXML->FindInInfoClass(szTextVal);
	...
	// Civ4 Reimagined
	pXML->GetChildXmlValByName(szTextVal, "NoAnarchyCivicOption");
	m_iNoAnarchyCivicOption = pXML->FindInInfoClass(szTextVal);
	...
	pXML->GetChildXmlValByName(&m_bPrereqPowerOr, "bPrereqPowerOr"); // Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_bPrereqPowerAnd, "bPrereqPowerAnd"); // Civ4 Reimagined
	...
	pXML->GetChildXmlValByName(&m_bUnlimitedBarbXP, "bUnlimitedBarbXP"); // Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_bBarbarianGreatGeneral, "bBarbarianGreatGeneral"); // Civ4 Reimagined
	...
	//pXML->GetChildXmlValByName(&m_iDefenseWarWearinessModifier, "iDefenseWarWearinessModifier"); // Civ4 Reimagined
	...
	pXML->GetChildXmlValByName(&m_iOverseaTradeRouteModifier, "iOverseaTradeRouteModifier"); // Civ4 Reimagined
	...
	pXML->GetChildXmlValByName(&m_iTargetAirStrike, "iTargetAirStrike");
	...
	// Civ4 Reimagined
	if (gDLL->getXMLIFace()->SetToChildByTagName(pXML->GetXML(),"CommercePerCultureLevel"))
	{
		pXML->SetCommerce(&m_piCommercePerCultureLevel);
		gDLL->getXMLIFace()->SetToParent(pXML->GetXML());
	}
	else
	{
	...
	// Civ4 Reimagined
	if (gDLL->getXMLIFace()->SetToChildByTagName(pXML->GetXML(),"CommerceFromCoast"))
	{
		pXML->SetCommerce(&m_piCommerceFromCoast);
		gDLL->getXMLIFace()->SetToParent(pXML->GetXML());
	}
	else
	{
		pXML->InitList(&m_piCommerceFromCoast, NUM_COMMERCE_TYPES);
	}

	// Civ4 Reimagined
	if (gDLL->getXMLIFace()->SetToChildByTagName(pXML->GetXML(),"CommerceFromAirlift"))
	{
		pXML->SetCommerce(&m_piCommerceFromAirlift);
		gDLL->getXMLIFace()->SetToParent(pXML->GetXML());
	}
	else
	{
		pXML->InitList(&m_piCommerceFromAirlift, NUM_COMMERCE_TYPES);
	}
	...
	pXML->SetVariableListTagPair(&m_piBonusUnitProductionModifiers, "BonusUnitProductionModifiers", sizeof(GC.getBonusInfo((BonusTypes)0)), GC.getNumBonusInfos()); // Civ4 Reimagined
	pXML->SetVariableListTagPair(&m_piBonusBuildingProductionModifiers, "BonusBuildingProductionModifiers", sizeof(GC.getBonusInfo((BonusTypes)0)), GC.getNumBonusInfos()); // Civ4 Reimagined
	pXML->SetVariableListTagPair(&m_piBonusProductionModifier, "BonusProductionModifiers", sizeof(GC.getBonusInfo((BonusTypes)0)), GC.getNumBonusInfos());
	...
	pXML->SetVariableListTagPair(&m_piPercentPrereqNumOfBuildingClass, "PercentPrereqBuildingClasses", sizeof(GC.getBuildingClassInfo((BuildingClassTypes)0)), GC.getNumBuildingClassInfos()); // Civ4 Reimagined
...
/************************************************************************************************/
	...
	if (gDLL->getXMLIFace()->SetToChildByTagName(pXML->GetXML(),"BonusCommerceModifiers"))
	{
		...
		if (gDLL->getXMLIFace()->SetToChildByTagName(pXML->GetXML(),"BonusCommerceModifier"))
		{
			...
			for(int ii=0;(!m_bAnyBonusCommerceModifier) && ii<GC.getNumBonusInfos(); ii++)
			{
				for(int ij=0; ij < NUM_COMMERCE_TYPES; ij++ )
				{
					if( m_ppaiBonusCommerceModifier[ii][ij] != 0 )
					{
						m_bAnyBonusCommerceModifier = true;
						break;
					}
	...
	if (gDLL->getXMLIFace()->SetToChildByTagName(pXML->GetXML(),"TechnologyYieldModifiers"))
	{
		iNumChildren = gDLL->getXMLIFace()->GetNumChildren(pXML->GetXML());

		if (gDLL->getXMLIFace()->SetToChildByTagName(pXML->GetXML(),"TechnologyYieldModifier"))
		{
			for(j=0;j<iNumChildren;j++)
			{
			...
			for(int ii=0;(!m_bAnyTechYieldModifier) && ii<GC.getNumTechInfos(); ii++)
			{
				for(int ij=0; ij < NUM_YIELD_TYPES; ij++ )
				{
...
bool CvBuildingInfo::readPass4(CvXMLLoadUtility* pXML)
{
	pXML->SetVariableListTagPair(&m_pbPrereqCivics, "PrereqCivics", sizeof(GC.getCivicInfo((CivicTypes)0)), GC.getNumCivicInfos());
...
m_piCivilizationBonusBias(NULL), // Civ4 Reimagined
...
CvCivilizationInfo::~CvCivilizationInfo()
{
	...
	SAFE_DELETE_ARRAY(m_piCivilizationBonusBias); // Civ4 Reimagined
...
// Civ4 Reimagined
int CvCivilizationInfo::getCivilizationBonusBias(int i) const
{
	FAssertMsg(i < GC.getNumBonusInfos(), "Index out of bounds");
	FAssertMsg(i > -1, "Index out of bounds");
	return m_piCivilizationBonusBias ? m_piCivilizationBonusBias[i] : -1;
}
...
void CvCivilizationInfo::read(FDataStreamBase* stream)
{
	...
	// Civ4 Reimagined
	SAFE_DELETE_ARRAY(m_piCivilizationBonusBias);
	m_piCivilizationBonusBias = new int[GC.getNumBonusInfos()];
	stream->Read(GC.getNumBonusInfos(), m_piCivilizationBonusBias);
...
void CvCivilizationInfo::write(FDataStreamBase* stream)
{
	...
	stream->Write(GC.getNumBonusInfos(), m_piCivilizationBonusBias); // Civ4 Reimagined
...
m_bAnger(false),
m_bUnits(false), //Leoreth
m_bBuildings(false) //Leoreth
{
}
...
// Civ4 Reimagined
int CvHandicapInfo::getUniquePowerCostPercent() const
{
	return m_iUniquePowerCostPercent; 
}

// Civ4 Reimagined
int CvHandicapInfo::getAIUniquePowerCostPercent() const
{
...
m_bTech(false),
m_bBad(false),
m_bUpgrade(false), //Civ4 Reimagined
m_iProduction(0), //Civ4 Reimagined
m_iFood(0), //Civ4 Reimagined
m_iCulture(0), //Civ4 Reimagined
m_iGreatPersonPoints(0), //Civ4 Reimagined
m_iGreatGeneralPoints(0), //Civ4 Reimagined
m_bSpecialPromotion(false) //Civ4 Reimagined
{
}
...
bool CvGoodyInfo::isUpgrade() const //Civ4 Reimagined
{
	return m_bUpgrade;
}

int CvGoodyInfo::getProduction() const //Civ4 Reimagined
{
	return m_iProduction;
}

int CvGoodyInfo::getFood() const //Civ4 Reimagined
{
	return m_iFood;
}

int CvGoodyInfo::getCulture() const //Civ4 Reimagined
{
	return m_iCulture;
}

int CvGoodyInfo::getGreatPersonPoints() const //Civ4 Reimagined
{
	return m_iGreatPersonPoints;
}

int CvGoodyInfo::getGreatGeneralPoints() const //Civ4 Reimagined
{
	return m_iGreatGeneralPoints;
}

bool CvGoodyInfo::isSpecialPromotion() const //Civ4 Reimagined
{
	return m_bSpecialPromotion;
}
...
bool CvGoodyInfo::read(CvXMLLoadUtility* pXML)
{
	...
	pXML->GetChildXmlValByName(&m_bUpgrade, "bUpgrade"); //Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_iProduction, "iProduction"); //Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_iFood, "iFood"); //Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_iCulture, "iCulture"); //Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_iGreatPersonPoints, "iGreatPersonPoints"); //Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_iGreatGeneralPoints, "iGreatGeneralPoints"); //Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_bSpecialPromotion, "bSpecialPromotion"); //Civ4 Reimagined
...
m_bRequiresCanFarmHills(false), //Civ4 Reimagined		
...
//Civ4 Reimagined
bool CvImprovementInfo::isRequiresCanFarmHills() const			
{
	return m_bRequiresCanFarmHills; 
}
...
void CvImprovementInfo::read(FDataStreamBase* stream)
{
	...
	stream->Read(&m_bRequiresCanFarmHills); //Civ4 Reimagined
...
void CvImprovementInfo::write(FDataStreamBase* stream)
{
	...
	stream->Write(m_bRequiresCanFarmHills);	//Civ4 Reimagined
...
bool CvImprovementInfo::read(CvXMLLoadUtility* pXML)
{
	...
	pXML->GetChildXmlValByName(&m_bRequiresCanFarmHills, "bRequiresCanFarmHills"); //Civ4 Reimagined
...
m_iSpreadCost(0),
m_iMaintenance(0),
m_bIsCoastal(false), // Civ4 Reimagined
m_bCorpSlaves(false), // Civ4 Reimagined
m_iMissionType(NO_MISSION),
m_iBonusProduced(NO_BONUS),
m_iEnablesSpread(NO_CIVIC), // Civ4 Reimagined
...
// Civ4 Reimagined
bool CvCorporationInfo::isCoastal() const
{
	return m_bIsCoastal;
}

// Civ4 Reimagined
bool CvCorporationInfo::isSlaves() const
{
	return m_bCorpSlaves;
}
...
// Civ4 Reimagined
int CvCorporationInfo::getNumBonuses() const
{
...
// Civ4 Reimagined
int CvCorporationInfo::getEnablesSpread() const
{
	return m_iEnablesSpread;
}
...
bool CvCorporationInfo::read(CvXMLLoadUtility* pXML)
{
	...
	pXML->GetChildXmlValByName(&m_bIsCoastal, "bCoastal"); // Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_bCorpSlaves, "bCorpSlaves"); // Civ4 Reimagined
	...
	if (gDLL->getXMLIFace()->SetToChildByTagName(pXML->GetXML(),"PrereqBonuses"))
	{
		...
		{
			int iNumSibs = gDLL->getXMLIFace()->GetNumChildren(pXML->GetXML());
			m_iNumBonuses = std::min(std::max(0,iNumSibs), GC.getNUM_CORPORATION_PREREQ_BONUSES()); //Civ4 Reimagined
	...
	// Civ4 Reimagined
	pXML->GetChildXmlValByName(szTextVal, "EnablesSpread");
	m_iEnablesSpread = pXML->FindInInfoClass(szTextVal);
...
m_iPrereqTech(NO_TECH), // Civ4 Reimagined
m_iHealth(0),
m_iHappiness(0),
m_iMaxAnarchy(0),											
m_iUpkeepModifier(0),									
...
CvTraitInfo::~CvTraitInfo()
{
	...
	SAFE_DELETE_ARRAY(m_paiFreeCommerce); // Civ4 Reimagined
	SAFE_DELETE_ARRAY(m_pabFreePromotionUnitCombat);
	SAFE_DELETE_ARRAY(m_pabFreePromotion);
}

// Civ4 Reimagined
int CvTraitInfo::getPrereqTech() const			
{
...
// Civ4 Reimagined
int CvTraitInfo::getBuildingProductionModifier() const	
{
	return m_iBuildingProductionModifier; 
}
...
// Civ4 Reimagined
int CvTraitInfo::getBonusValueModifier() const	
{
	return m_iBonusValueModifier;
}

// Civ4 Reimagined
int CvTraitInfo::getVassalCommerceGain() const	
{
	return m_iVassalCommerceGain; 
}

// Civ4 Reimagined
bool CvTraitInfo::isNoPillage() const	
{
	return m_bIsNoPillage; 
}
...
// Civ4 Reimagined
int CvTraitInfo::getFreeCommerce(int i) const		
{
	return m_paiFreeCommerce ? m_paiFreeCommerce[i] : -1; 
}
...
bool CvTraitInfo::read(CvXMLLoadUtility* pXML)
{
	...
	pXML->GetChildXmlValByName(&m_iBuildingProductionModifier, "iBuildingProductionModifier"); // Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_iDistanceMaintenanceModifier, "iDistanceMaintenanceModifier"); // Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_iBonusValueModifier, "iBonusValueModifier"); // Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_iVassalCommerceGain, "iVassalCommerceGain"); // Civ4 Reimagined
	pXML->GetChildXmlValByName(&m_bIsNoPillage, "bIsNoPillage"); // Civ4 Reimagined
	...
	// Civ4 Reimagined
	if (gDLL->getXMLIFace()->SetToChildByTagName(pXML->GetXML(), "FreeCommerce"))
	{
		pXML->SetCommerce(&m_paiFreeCommerce);
		gDLL->getXMLIFace()->SetToParent(pXML->GetXML());
	}
	else
	{
		pXML->InitList(&m_paiFreeCommerce, NUM_COMMERCE_TYPES);
	}
