...
/************************************************************************************************/
	...
	python::class_<CvBuildingInfo, python::bases<CvInfoBase, CvScalableInfo> >("CvBuildingInfo")
		...
		.def("getPercentPrereqNumOfBuildingClass", &CvBuildingInfo::getPercentPrereqNumOfBuildingClass, "int (int i)")
		...
		.def("isPrereqCivic", &CvBuildingInfo::isPrereqCivic, "bool (int i)")
