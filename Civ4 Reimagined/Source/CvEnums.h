...
enum FontSymbols					// Exposed to Python
{
	...
	OCCUPATION_CHAR,
	POWER_CHAR,
	RAND1_CHAR, // Civ4 Reimagined: Since all names are associated in the order they are listed here, the rand_chars are fillers to assign the slave_char to the correct symbol.
	RAND2_CHAR, // Civ4 Reimagined
	RAND3_CHAR, // Civ4 Reimagined
	RAND4_CHAR, // Civ4 Reimagined
	RAND5_CHAR, // Civ4 Reimagined
	RAND6_CHAR, // Civ4 Reimagined
	RAND7_CHAR, // Civ4 Reimagined
	RAND8_CHAR, // Civ4 Reimagined
	RAND9_CHAR, // Civ4 Reimagined
	SLAVE_CHAR, // Civ4 Reimagined
	BOW_CHAR, // Civ4 Reimagined
...
enum DenialTypes				// Exposed to Python
{
	...
	DENIAL_IDEOLOGY // Civ4 Reimagined
};
...
enum MemoryTypes							// Exposed to Python 
{
	...
	MEMORY_BACKSTABBED_ALLY, // Civ4 Reimagined
