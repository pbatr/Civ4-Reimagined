...
// BUG - Building Additional Great People - end
	...
	DllExport void parseSlaveryBarHelp(CvWStringBuffer &szBuffer, CvPlayer& kPlayer);
...
// BUG - Building Additional Happiness - end
	DllExport bool setYieldChangeHelp(CvWStringBuffer &szBuffer, const CvWString& szStart, const CvWString& szSpace, const CvWString& szEnd, const int* piYieldChange, bool bPercent = false, bool bNewLine = true); // Civ4 Reimagined: Added bool return
...
// BUG - Building Additional info - end
	...
	DllExport void buildSeaPlotYieldString( CvWStringBuffer &szBuffer, TechTypes eTech, bool bList = false, bool bPlayerContext = false ); // Civ4 Reimagined
	DllExport void buildIdeologiesString( CvWStringBuffer &szBuffer, TechTypes eTech, bool bList = false, bool bPlayerContext = false ); // Civ4 Reimagined
	...
	void buildIdeologyRevealString( CvWStringBuffer& szBuffer, TechTypes eTech, int iIdeologyType); // Civ4 Reimagined
