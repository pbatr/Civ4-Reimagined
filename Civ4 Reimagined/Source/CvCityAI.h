...
protected:
	...
	long m_aiBestBuildValue[NUM_CITY_PLOTS]; // Civ4 Reimagined
	...
	void AI_bestPlotBuild(CvPlot* pPlot, long* piBestValue, BuildTypes* peBestBuild, int iFoodPriority, int iProductionPriority, int iCommercePriority, bool bChop, int iHappyAdjust, int iHealthAdjust, int iDesiredFoodChange);
