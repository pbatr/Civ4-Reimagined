...
struct DllExport CombatDetails					// Exposed to Python
{
	...
	int iDefenseBuildingModifier; //Civ4 Reimagined
...
public:
	...
	bool bombard();
	void bombardCity(CvCity* pCity, int bombardRate); // Civ4 Reimagined
	...
	bool canPlunderCity(const CvCity* pCity) const;
	...
	int getGreatPersonBulbScaling() const; // Civ4 Reimagined
	...
	bool testSpyIntercepted(PlayerTypes eTargetPlayer, bool bMission, int iModifier = 0); // (K-Mod added bMission)
