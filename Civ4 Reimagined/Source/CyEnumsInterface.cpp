...
void CyEnumsPythonInterface()
{
	...
	python::enum_<InterfaceModeTypes>("InterfaceModeTypes")
		...
		.value("INTERFACEMODE_COASTAL_RAID", INTERFACEMODE_COASTAL_RAID) // Civ4 Reimagined
	...
	python::enum_<WidgetTypes>("WidgetTypes")
		...
		.value("WIDGET_HELP_BONUS_RATIO", WIDGET_HELP_BONUS_RATIO) // Civ4 Reimagined
		.value("WIDGET_HELP_BONUS_SUM", WIDGET_HELP_BONUS_SUM) // Civ4 Reimagined
		...
		.value("WIDGET_HELP_SLAVERY_BAR", WIDGET_HELP_SLAVERY_BAR)
		.value("WIDGET_INSTABILITY_PROGRESS_BAR", WIDGET_INSTABILITY_PROGRESS_BAR) // Civ4 Reimagined
		...
		.value("WIDGET_HELP_SEA_PLOT_YIELD", WIDGET_HELP_SEA_PLOT_YIELD) // Civ4 Reimagined
		.value("WIDGET_HELP_ENABLE_IDEOLOGIES", WIDGET_HELP_ENABLE_IDEOLOGIES) // Civ4 Reimagined
...
*/
	...
	python::enum_<WorldSizeTypes>("WorldSizeTypes")
		...
		.value("WORLDSIZE_EPIC", WORLDSIZE_EPIC)
		.value("WORLDSIZE_TOTESTRA", WORLDSIZE_TOTESTRA)
	...
	python::enum_<GameOptionTypes>("GameOptionTypes")
		...
		.value("GAMEOPTION_NO_COLONY_ANGER", GAMEOPTION_NO_COLONY_ANGER) //Civ4 Reimagined
		.value("GAMEOPTION_UNLIMITED_WORKERS", GAMEOPTION_UNLIMITED_WORKERS) //Civ4 Reimagined
	...
	python::enum_<FontSymbols>("FontSymbols")
		...
		.value("SLAVE_CHAR", SLAVE_CHAR) // Civ4 Reimagined
		.value("BOW_CHAR", BOW_CHAR) // Civ4 Reimagined
	...
	python::enum_<MissionTypes>("MissionTypes")
		...
		.value("MISSION_SACRIFICE", MISSION_SACRIFICE)  // Civ4 Reimagined
		.value("MISSION_COASTAL_RAID", MISSION_COASTAL_RAID) // Civ4 Reimagined
	...
	python::enum_<MemoryTypes>("MemoryTypes")
		...
		.value("MEMORY_BACKSTABBED_ALLY", MEMORY_BACKSTABBED_ALLY)
