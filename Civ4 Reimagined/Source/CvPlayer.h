...
/************************************************************************************************/
	...
	// Civ4 Reimagined
	DllExport void revolution(CivicTypes* paeNewCivics, bool bForce = false, bool bAnarchy = true);	// Exposed to Python
	...
	// Civ4 Reimagined
	int getNoGreatPeopleCount() const;
	bool isNoGreatPeople() const;
	void changeNoGreatPeopleCount(int iChange);
	
	// Civ4 Reimagined
	int getNoCultureFlipCount() const;
	bool isNoCultureFlip() const;
	void changeNoCultureFlipCount(int iChange);
	
	// Civ4 Reimagined
	int getNoCapitalCount() const;
	bool isNoCapital() const;
	void changeNoCapitalCount(int iChange);
	...
	int getBuildingsProductionModifier() const; // Civ4 Reimagined
	void changeBuildingsProductionModifier(int iChange); // Civ4 Reimagined
	...
	// Civ4 Reimagined
	int getNoUnitSupplyCount() const;	
	bool isNoUnitSupply() const;
	void changeNoUnitSupplyCount(int iChange);
	...
	bool isNoMilitaryProductionMali() const; // Exposed to Python
	void changeNoMilitaryProductionMaliCount(int iChange);
	...
	// Civ4 Reimagined
	int getLootingModifier() const;
	void changeLootingModifier(int iChange);
	
	// Civ4 Reimagined
	bool isBarbarianGreatGeneral() const;
	void changeBarbarianGreatGeneralCount(int iChange);
	
	// Civ4 Reimagined
	bool isUnlimitedBarbXP() const;
	void changeUnlimitedBarbXPCount(int iChange);
	
	// Civ4 Reimagined
	bool isNoWarAgainstSameFaithUnhappiness() const;
	void changeNoWarAgainstSameFaithUnhappinessCount(int iChange);
	
	// Civ4 Reimagined
	bool isUnlimitedAnimalXP() const;
	void changeUnlimitedAnimalXPCount(int iChange);
	
	// Civ4 Reimagined
	bool canExploreSea() const;	
	void setCanExploreSea(bool bNewValue);
...
*/
	...
	int getColonyMaintenanceModifier() const; // Civ4 Reimagined
	void changeColonyMaintenanceModifier(int iChange); // Civ4 Reimagined
	...
	void changePopulationUnhappinessModifier(int iChange);
	int getBonusValueModifier() const; // Exposed to Python
	void changeBonusValueModifier(int iChange);
	int getVassalCommerceGain() const;
	void changeVassalCommerceGain(int iChange);
	bool isNoPillage() const;
	void changeIsNoPillageCount(int iChange);
	// Civ4 Reimagined End
	...
	// Civ4 Reimagined
	int getNoCapitalUnhappinessCount() const;
	...
	void changeLargestCityHappiness(int iChange);
	 ...
	 // Civ4 Reimagined
	int getGoldPerHappinessBonus() const;
	void changeGoldPerHappinessBonus(int iChange, bool bRecalculate = false);
	void recalculateGoldPerHappinessBonusForNewCapital();
	...
	// Civ4 Reimagined
	int getDomesticTradeModifier() const;
	void changeDomesticTradeModifier(int iChange);
	int getColonyTradeModifier() const;
	void changeColonyTradeModifier(int iChange);
	int getCapitalTradeModifier() const;
	void changeCapitalTradeModifier(int iChange);
	
	// Civ4 Reimagined
	bool isColony(PlayerTypes eMaster) const;
	...
	// Civ4 Reimagined
	int getInitCityCommerce(CommerceTypes eIndex) const;	
	void changeInitCityCommerce(CommerceTypes eIndex, int iChange);
	...
	int getCapitalCommerceRateModifierPerHappinessSurplus(CommerceTypes eIndex) const; //Civ4 Reimagined
	void changeCapitalCommerceRateModifierPerHappinessSurplus(CommerceTypes eIndex, int iChange); //Civ4 Reimagined
	
	int getCommerceHappiness(CommerceTypes eIndex) const;	//Civ4 Reimagined
	void changeCommerceHappiness(CommerceTypes eIndex, int iChange);	//Civ4 Reimagined
	...
	// Civ4 Reimagined
	int getHasNoAnarchyCivicOptionCount(CivicOptionTypes eIndex) const;
	bool isHasNoAnarchyCivicOption(CivicOptionTypes eIndex) const;
	void changeHasNoAnarchyCivicOptionCount(CivicOptionTypes eIndex, int iChange);
	...
	CvCity* addCity();	
	void deleteCity(int iID);// unit iteration	
	...
	void updateNumColonies(); // Civ4 Reimagined
	*/
	void updateColonialCities(); // Civ4 Reimagined
	int getUnitUpgradeCostModifier() const; // Civ4 Reimagined
	void changeUnitUpgradeCostModifier(int iChange); // Civ4 Reimagined
	bool isNoForeignCultureUnhappiness() const; // Civ4 Reimagined
	void changeNoForeignCultureUnhappinessCount(int iChange); // Civ4 Reimagined
	bool isNoCityResistance() const; // Civ4 Reimagined
	void changeNoCityResistanceCount(int iChange); // Civ4 Reimagined
	int getProductionPerSurplusHappiness() const; // Civ4 Reimagined
	void changeProductionPerSurplusHappiness(int iChange); // Civ4 Reimagined
	int getForeignUnitSupply() const; // Civ4 Reimagined
	void changeForeignUnitSupply(int iChange); // Civ4 Reimagined
	int getPillageGainModifier() const; // Civ4 Reimagined
	void changePillageGainModifier(int iChange); // Civ4 Reimagined
	int getTechValue() const; // Civ4 Reimagined // Exposed to Python
	...
	int getCoastalTradeRouteModifier() const; // Civ4 Reimagined
	...
	void changeFreeUnitsOnConquest(int iChange); // Civ4 Reimagined
	int getReligionTechModifier() const; // Civ4 Reimagined
	void changeReligionTechModifier(int iChange); // Civ4 Reimagined
	int getUniquePowerBuildingModifier() const; // Civ4 Reimagined
	void changeUniquePowerBuildingModifier(int iChange); // Civ4 Reimagined
	int getEarlyWorkerSpeedModifier() const; // Civ4 Reimagined
	void changeEarlyWorkerSpeedModifier(int iChange); // Civ4 Reimagined
	int getFatcrossTerrainHappiness(TerrainTypes eIndex) const; // Civ4 Reimagined
	void changeFatcrossTerrainHappiness(TerrainTypes eIndex, int iChange); // Civ4 Reimagined
	int getFatcrossTerrainCulture(TerrainTypes eIndex) const; // Civ4 Reimagined 
	...
	void uniquePowerAIEraValueMult(EraTypes iEra); // Civ4 Reimagined
	void updateUniquePowers(EraTypes iEra); // Civ4 Reimagined
	...
	bool isSpecialTradeRoutePerPlayer() const; // Civ4 Reimagined
	void setSpecialTradeRoutePerPlayer(bool bNewValue); // Civ4 Reimagined
	int getPlayerExtraAvailableBonuses(BonusTypes eBonus) const; // Civ4 Reimagined
	void changePlayerExtraAvailableBonuses(BonusTypes eBonus, int iChange); // Civ4 Reimagined
	bool isHasExtraAvailableBonuses() const; // Civ4 Reimagined
	...
	virtual TechTypes AI_bestTech(int iMaxPathLength = 1, bool bIgnoreCost = false, bool bAsync = false, TechTypes eIgnoreTech = NO_TECH, AdvisorTypes eIgnoreAdvisor = NO_ADVISOR, EraTypes eMaxEra = NO_ERA) const = 0;
	virtual void AI_chooseFreeTech(EraTypes eMaxEra = NO_ERA) = 0;
...
protected:
	...
	int m_iNoGreatPeopleCount; // Civ4 Reimagined
	int m_iNoCultureFlipCount; // Civ4 Reimagined
	int m_iNoCapitalCount; // Civ4 Reimagined
	...
	int m_iBuildingsProductionModifier; // Civ4 Reimagined
	...
	int m_iNoUnitSupplyCount; // Civ4 Reimagined
	...
	int m_iHighestNavalUnitLevel; // Civ4 Reimagined
	int m_iLootingModifier; // Civ4 Reimagined
	int m_iBarbarianGreatGeneralCount; // Civ4 Reimagined
	int m_iUnlimitedBarbXPCount; // Civ4 Reimagined
	int m_iNoWarAgainstSameFaithUnhappinessCount; // Civ4 Reimagined
	int m_iUnlimitedAnimalXPCount; // Civ4 Reimagined
	...
	int m_iBonusValueModifier; // Civ4 Reimagined
	int m_iVassalCommerceGain; // Civ4 Reimagined
	int m_iIsNoPillageCount; // Civ4 Reimagined
	int m_iNumCitiesMaintenanceModifier;
	int m_iColonyMaintenanceModifier; // Civ4 Reimagined
	...
	int m_iPopulationUnhappinessModifier; // Civ4 Reimagined
	int m_iBuildingGoodHealth;
	int m_iBuildingBadHealth;
	int m_iExtraHappiness;
	int m_iCivicHappiness; // Civ4 Reimagined
	int m_iNoCapitalUnhappinessCount; // Civ4 Reimagined
	int m_iBuildingHappiness;
	int m_iLargestCityHappiness;
	int m_iGoldPerHappinessBonus; // Civ4 Reimagined
	...
	int m_iUnitUpgradeCostModifier; // Civ4 Reimagined
	int m_iProductionPerSurplusHappiness; // Civ4 Reimagined
	int m_iForeignUnitSupply; // Civ4 Reimagined
	int m_iPillageGainModifier; // Civ4 Reimagined
	...
	int m_iFatcrossPeakCulture; // Civ4 Reimagined
	...
	int* m_aiInitCityCommerce; //Civ4 Reimagined
	int* m_aiUniquePowerCommerceModifier; //Civ4 Reimagined
	...
	//int* m_aiUnitProductionModifier; // Civ4 Reimagined
	...
	int* m_paiHasNoAnarchyCivicOptionCount; // Civ4 Reimagined
	...
	std::pair<int,int> * a_tCapitalCommercePerPopulation; // Civ4 Reimagined
