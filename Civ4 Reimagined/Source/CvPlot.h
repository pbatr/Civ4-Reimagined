...
public:
	...
	void forceBumpEnemyNavalUnits(TeamTypes eTeam); // Civ4 Reimagined
	...
	int getAdjacentPlotGroupConnectedBonus(PlayerTypes ePlayer, BonusTypes eBonus) const;
	...
	int defenseModifier(TeamTypes eDefender, bool bIgnoreBuilding, bool bHelp = false, int iDefenseBuildingModifier = 0) const;									// Exposed to Python				
