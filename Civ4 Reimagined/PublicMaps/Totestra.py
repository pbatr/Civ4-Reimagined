...
from CvMapGeneratorUtil import BonusBalancer #Civ4 Reimagined
import math
import sys
import time
import os

balancer = BonusBalancer() #Civ4 Reimagined
...
## GLOBAL TUNING VARIABLES: Change these to customize the map results
        ...
        self.TreeFactor = 1.2 #Civ4 Reimagined, was 1.5

        #This is the maximum chance for a tree to be placed when rainfall is above jungle level.
        #use a value between 0.0 and 1.0
        self.MaxTreeChance = 1 #Civ4 Reimagined, was 1
		
        #Civ4 Reimagined: Reduce Treespread with this variable. 1.0 is standard Totestra value.
        self.TreeChance = 0.8
        ...
        self.CommerceValue = 15 #Civ4 Reimagined
        self.ProductionValue = 30 #Civ4 Reimagined
        self.FoodValue = 40 #Civ4 Reimagined

        #Coastal cities are important, how important is determined by this
        #value.
        self.CoastalCityValueBonus = 1.25 #Civ4 Reimagined
    ...
    def initInGameOptions(self):
        ...
        if seaLevel == 0:
            self.landPercent = 0.41 #Civ4 Reimagined
        elif seaLevel == 2:
        ...
        self.PeakPercent = 0.03 #Civ4 Reimagined
        ...
        #be 'peaks'.
        self.HillPercent = 0.25 #Civ4 Reimagined
        ...
        self.HillChanceAtOne = .40 #Civ4 Reimagined
        self.PeakChanceAtOne = .22 #Civ4 Reimagined
        ...
        self.DesertPercent = 0.075 #Civ4 Reimagined
        ...
        self.iceRange = 5 # Number of squares we add icebergs to #Civ4 Reimagined
        self.iceSlope = 0.7 # How quickly we reduce icebergs #Civ4 Reimagined
	...
	# resources should the map as a whole have? 
        ...
        #a bonus.
        self.BonusBonus = 1 #Civ4 Reimagined
...
class BonusPlacer :
    ...
    def AddBonuses(self):
        #Civ4 Reimagined
        CyPythonMgr().allowDefaultImpl() # pretend we didn't implement this method, and let C handle this in the default way
        # gc = CyGlobalContext()
        # gameMap = CyMap()
...
##            areasPerBonus = (len(areaSuitabilityList)/numUniqueBonuses) + 1
    ...
    def PlotCanHaveBonus(self,plot,eBonus,bIgnoreLatitude,bIgnoreArea):
        #This function is like CvPlot::canHaveBonus #Civ4 Reimagined
        gc = CyGlobalContext()
    ...
    def SetStartingPlots(self):
        try:
            ...
            for i in range(len(areas)):
                if areaOldWorld[i] == True and areas[i].getNumTiles() > 45: #Civ4 Reimagined, was 5
...
#        game.gc.getGame()
    ...
    def getPlotPotentialValue(self,x,y,coastalCity):
        ...
        if not coastalCity and plot.isWater():
            value -= 300 #Civ4 Reimagined
            food = 0
        #Civ4 Reimagined:
        if bonusEnum != -1 and value > 0:
            value *= 2
        #Food surplus makes the square much more valueable than if there
        #is no food here.
        if food >= gc.getFOOD_CONSUMPTION_PER_POPULATION() and value > 0:
            value *= 4
        elif food == gc.getFOOD_CONSUMPTION_PER_POPULATION() - 1 and value > 0:
            value *= 2
        if food + commerce + production < 3 and value > 0: #Civ4 Reimagined
            value = 0
...
#    return
def normalizeAddExtras(): #Civ4 Reimagined
...
def getGridSize(argsList):
    grid_sizes = {
		...
		WorldSizeTypes.WORLDSIZE_EPIC:		(36,24), #Civ4 Reimagined
		WorldSizeTypes.WORLDSIZE_TOTESTRA:		(36,24) #Civ4 Reimagined
    }
        ...
        for x in range(mc.width):
            ...
            plot.isPeak() == False:
                ...
                PRand.random() < mc.MaxTreeChance:#jungle
                    if PRand.random() < mc.TreeChance: #Civ4 Reimagined				
